...
<ul>
	...
	<li>Backups are in tab-separated format, so you can easily edit them in a spreadsheet application. For help with creating new rules when using a spreadsheet application, visit https://www.getclearthinking.com/editing-backup-files</li>
</ul>
';
...
$_['entry_charge_sorting']				= 'Charge Sorting: <div class="help-text">Choose whether to sort charges by cost or by Group value. If using Charge Combinations, the Sort Order of the combination counts as the Group value.</div>';
$_['text_sort_by_cost']					= 'Sort by Cost';
$_['text_sort_by_group']				= 'Sort by Group';
...
$_['help_charge_type']					= 'Select the basis for the charge:<br><br>&bull; A simple flat charge or per item charge<br><br>&bull; A charge based on brackets (quantity, total, weight, etc.)<hr>"Price" will look at the individual product prices, ignoring the quantity of the product.<br><br>"Product Count" will look at the number of products in the cart, ignoring the quantities of each product.';
$_['help_charge_charges']				= 'For "Simple Charges", enter the flat charge or per item charge (such as 5.00) or a percentage (such as 10%).<hr />For "Bracket Charges", separate brackets by commas or new lines, and enter them in the format:<br><br><b>From - To = Cost / Per</b><br><br>The "Per" value is optional. If you leave out the "From" value, it will mean "Up To" that value.<br><br>For example, to charge $5.00 for 0-3 kg, and $2.00 per kg for 3+ kg, you would choose "Weight" for the charge type and enter:<br><div class="text-left" style="margin: 10px 0 10px 50px">0-3 = 5.00<br>3-9999 = 2.00 / 1</div>If the items weighed 5 kg, that would be a cost of $10.00. If you instead wanted the $5.00 added together with the $2.00 per kg cost, so 5 kg would be<br>$5.00 + $2.00 x 2 = $9.00<br>then you would add a "Cumulative Brackets" rule.';
...
$_['text_is_on_or_after']				= 'is on or after';
$_['text_is_on_or_before']				= 'is on or before';
...
$_['column_title_override']				= 'Title Override';
...
$_['help_combination_title_override']	= 'If a title is entered in this field, it will always be used for the resulting combination. This will override the "Title Combination" setting. This field is for';
...
$_['help_combination_formula']			= 'Enter a formula for how the charges are combined together.<br><br><b>SUM</b> = Sum of all charges<br><b>AVG</b> = Average of all charges<br><b>MAX</b> = Highest of all charges<br><b>MIN</b> = Lowest of all charges<br><b>MULT</b> = Product of all charges<br><br>Use the charge&#39;s Group value to designate which charges are part of the combination. For example, to add together all charges for Groups A and B, you would enter:<br><br><span style="font-family: monospace; font-size: 14px">SUM(A, B)</span><br><br>To take the highest of either the sum of Group A, or the average of Group B, you would enter:<br><br><span style="font-family: monospace; font-size: 14px">MAX(SUM(A), AVG(B))</span><br><br>If you enter a numeric value and the corresponding Group value does not exist then it will be interpreted as a flat cost. To add $5.00 to Group A, enter this:<br><br><span style="font-family: monospace; font-size: 14px">SUM(A, 5)</span>';
...
//------------------------------------------------------------------------------
$_['help_charges']						= 'By default, charges are always available. Use "Rules" to restrict a charge by specific criteria such as payment method, geo zone, or customer group.';
