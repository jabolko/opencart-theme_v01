...
//namespace Opencart\Admin\Controller\Extension\RestrictPayment\Module;
//class RestrictPayment extends \Opencart\System\Engine\Controller {

class ControllerExtensionModuleRestrictPayment extends Controller {
	...
	public function index() {
		...
		if (version_compare(VERSION, '4.0', '>=')) {
			...
			if (empty($event)) {
				...
				$triggers = array(
					'catalog/model/setting/extension/getExtensionsByType/after'	=> $extension_base,
				);
		...
		$data['rule_options'] = array(
			...
			'order_criteria'			=> array('currency', 'customer_group', 'language', 'shipping_cost', 'shipping_extension', 'shipping_rate', 'store'),
